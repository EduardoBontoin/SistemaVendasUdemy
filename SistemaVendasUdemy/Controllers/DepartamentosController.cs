...
namespace SistemaVendasUdemy.Controllers
{
    ...
    {
        private readonly SistemaVendasUdemyContext _context;

        public DepartamentosController(SistemaVendasUdemyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SistemaVendasUdemyContext.Departamento'  is null.");
            }
            var departamento = await _context.Departamento.FindAsync(id);
            if (departamento != null)
            {
